        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Height = table.Column<decimal>(type: "decimal(5,2)", nullable: true, comment: "Height in centimeters"),
                    Weight = table.Column<decimal>(type: "decimal(5,2)", nullable: true, comment: "Weight in kilograms"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deleted = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVipSupported = table.Column<bool>(type: "bit", nullable: false),
                    IsCorporatePartner = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GymFacilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GymFacilities_Gyms_GymId",
                        column: x => x.GymId,
                        principalTable: "Gyms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetCarbs = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TargetFats = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    IsCustomPlan = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DietPlans_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DietPlans_Trainers_CreatedByTrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserSubscriptions_Trainers_AssignedTrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkoutPlans_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutPlans_Trainers_CreatedByTrainerId",
                        column: x => x.CreatedByTrainerId,
                        principalTable: "Trainers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedCalories = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "DietPlanProgresses",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DietPlanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RecordDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ActualCalories = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ActualProtein = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ActualCarbs = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ActualFats = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietPlanProgresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DietPlanProgresses_DietPlans_DietPlanId",
                        column: x => x.DietPlanId,
                        principalTable: "DietPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MusclePercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutPlanProgresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkoutPlanProgresses_WorkoutPlans_WorkoutPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietPlanProgresses_DietPlanId",
                table: "DietPlanProgresses",
                column: "DietPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_DietPlans_CreatedByTrainerId",
                table: "DietPlans",
                column: "CreatedByTrainerId");

            migrationBuilder.CreateIndex(
                name: "IX_DietPlans_UserId1",
                table: "DietPlans",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_GymFacilities_GymId",
                table: "GymFacilities",
                column: "GymId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptions_AssignedTrainerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutPlanProgresses_WorkoutPlanId",
                table: "WorkoutPlanProgresses",
